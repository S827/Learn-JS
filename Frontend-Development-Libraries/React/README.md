...
1. What is a React component?
React components are independent and reusable bits of code. It serve the same purpose as javascript function does, 2 types of react components: class components and functional components
...
```
components should use Pascal Case in naming the component.
...
ReactDOM.render(Header(), document.getElementById("root"))
```
in the last line, the 1st argument should be <Header />
